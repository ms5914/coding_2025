...
#let initial k elements be in the heap and just remove out of window largest elements in every insertion so that you always get the largest in the current window.
